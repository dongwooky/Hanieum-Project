...
#    depth_frame = np.where(depth_frame)
    depth_frame = np.where(depth_frame >= 500, 0, depth_frame)
    depth_frame = np.where(depth_frame >= 465, 85, depth_frame)
    depth_frame = np.where(depth_frame >= 435, 170, depth_frame)
    depth_frame = np.where(depth_frame >= 405, 255, depth_frame)
    depth_frame = np.where((depth_frame != 85) & (depth_frame != 170) & (depth_frame != 255), 0, depth_frame)
    ...
    cv2.imshow('depth_frame', depth_frame.astype('uint8'))
